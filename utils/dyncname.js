var userNickname = ['John', 'Michelle', 'Amy', 'Kim', 'Mary', 'David', 'Sunny', 'James', 'Maria', 'Michael', 'Sarah', 'Robert', 'Lily'
...
/**
 * get a random from userNickName
 * @returns {string}
 */
exports.randomNickName = function () {
    var name = userNickname[dyncutils.randomNumber(200)];
    return name;
}